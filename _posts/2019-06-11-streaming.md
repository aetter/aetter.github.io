...
All that hedging aside, I'd argue that Google's new Stadia game service is different. We know the answers to the most important questions, and those answers are not encouraging. In its current form, I don't see Stadia ever occupying more than a tiny niche in the gaming landscape.
...
If physical disks are such a pox on profitability, publishers have an easy solution: move to a digital-only publishing model. Either way, they have to meet customers in the middle. Stadia games should be cheaper than digital games, which should be cheaper than physical games. But of course, they're all the same price. Customers are used to *owning* something. If you take away that ownership, you can't possibly charge them the same amount. Office 2019 costs $250, whereas Office 365 is $100 a year. Photoshop CS6 is $700, or you can have the latest version for $120 a year.
