...
All enduring technology follows this path. The need for great documentation decreases as products mature and audience understanding of a technology increases. The same developer who throws out the manual to a new vacuum cleaner might spend hours scanning the Python documentation. People don’t ignore documentation. They read it in vast quantities. But people *do* ignore excessive documentation of well-understood subjects.
...
But let's say you disagree with me. You believe that, by the end of my career, a bot will be able to do my job nearly as well as I can and won’t have pesky needs like eating and sleeping.
